          ...
          <div id="history-section">
            ...
            <div class="history-info">
              ...
              <p>
                ...
                watching matches, daily summaries in all tournaments, by working
                to put all the details for each match through a special page for
                each match, to which the channels transmitting match summaries
                and commentators are provided, and match summaries are provided
                for most Arab countries, while ensuring that the latest news is
                posted. European and Arab sports, local and international, that
                the site will provide you with full information about all
                European and Arab teams
              </p>
