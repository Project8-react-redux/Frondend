                    ...
                    <div className='bg-light d-flex align-items-center flex-wrap gap-2'>
                        ...
                        <div className='col-md-4' id='date'>
                            <form action="">
                                ...
                                <input min={fromDate} name='from' value={dateAndLeague.from} onChange={handeLOnChange} type="date" id='start' />

                                <label for="end">To:</label>
                                <input min={fromDate} max={toDate} value={dateAndLeague.To} onChange={handeLOnChange} type="date" name='To' id='end' />
                            </form>
                        </div>
                    </div>
                    <div className="row">
